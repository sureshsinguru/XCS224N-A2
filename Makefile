...
#   Creates the A2_Solutions.pdf handout.  Removes auxiliary studenlatex files
#   after compilation.
# `make without_solutions`
#   Creates the A2.pdf handout.  Removes auxiliary latex files after
...
#
# $ latexmk -pvc -jobname="A2_Solutions"
#
# (Of course, substituting the "A2" for the assignment root document)
#
